    ...
    <div>
      <div className="lg:container">
        <div className="lg:flex justify-center items-center">
                ...
                <div className="flex items-center gap-3 whitespace-nowrap w-full">
                  {users?.map((user, i) => (
                    <div
                      ...
                      key={i}
                      className="flex-shrink-0 cursor-pointer relative flex items-center flex-col"
                    >
                      <img
          ...
          {((!isDesktop && showChat) || isDesktop) &&
            <div
              className="lg:w-[70%] bg-white z-20 border-l min-h-screen relative"
              style={{
                    ...
                    <div className="flex justify-between px-4">
                      <div className="flex gap-4 items-center text-black">
                        ...
                        <div className="flex flex-col gap-1">
                          <p className="text-black cursor-pointer text-[12px] md:text-[16px] -ml-1">{chat?.name}</p>
